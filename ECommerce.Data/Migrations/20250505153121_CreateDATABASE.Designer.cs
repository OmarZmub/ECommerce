...
namespace ECommerce.Migrations
{
    ...
    [Migration("20250505153121_CreateDATABASE")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Data.Models.BankFee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.OrderStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.PaymentDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.PaymentStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.ShippingRegion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.StockMovement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ECommerce.Data.Models.Address", b =>
                {
                    b.HasOne("ECommerce.Data.Models.ShippingRegion", "Region")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ECommerce.Data.Models.Order", b =>
                {
                    ...
                    b.HasOne("ECommerce.Data.Models.Address", "ShippingAddress")
                        .WithMany("Orders")
                        .HasForeignKey("ShippingAddressId")
                        .IsRequired()
                        .HasConstraintName("FK_Orders_Addresses");

                    b.HasOne("ECommerce.Data.Models.OrderStatus", "Status")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ECommerce.Data.Models.PaymentDetail", b =>
                {
                    ...
                    b.HasOne("ECommerce.Data.Models.PaymentStatus", "Status")
                        .WithMany("PaymentDetails")
                        .HasForeignKey("StatusId")
                        .IsRequired()
